...
class Parameters:
    ...
    CONFIG_VALUES: Dict[str, Tuple[Any, Any, str]] = dict(
        ...
        nseed=(0, int, ("Seed for RandomState. Must be convertible to 32 bit "
                        "unsigned integers")),
        product_type=("all", str,
                      ("Type of SWOT product to be generated. Possible "
                       f"products are classic, expert"
                       f"Default to classic")),
        ...
        proc_number=(1, int, "Number of processors to be used"),
        progress_bar=(True, bool, "Deactivate printing of progress bar to avoid huge log"),
        filesgrid=(None, str,
                   ("Satellite grid file root name:"
                    "(Final file name is root_name_[numberofpass].nc)")),
        makesgrid=(True, bool, "Force the computation of the satellite grid:"),
        file_input=(None, str, "List of model files:"),
        file_grid_model=(None, str, "Specify path for file coordinates"),
        model=("NETCDF_MODEL", str, "Type of model data"),
        first_time=("2011-11-15T00:00:00Z", str, "First time of the model"),
        grid=('regular', str, "Type of grid:"),
        indatadir=('', str, "Input data path"),
        list_input_var=({'ssh_true': ['SSH', '']}, list,
                        ("Specify list of variables, using the format:"
                         "{key: [variable_name,file_suffix], ...}}")),
        ...
        file_output=("SWOT_", str, "output file root_name"),
        interpolation=("linear", str, "Type of interpolation"),
        lambda_cut=(20000, int,
                    "Wavelength cut off to simulate crossover calibration"),
        lambda_max=(20000, int,
                    "Max Wavelength to consider for spectral noise"),
